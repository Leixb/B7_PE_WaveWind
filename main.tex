...
Para reducir la cantidad de datos que utilizamos en nuestro estudio hemos decidido considerar solo los datos de entre las 8:00 y las 17:00 ya que es el 
...
\begin{table}[htbp]
\centering
\input{tables/summary_nazare500.tex}
\caption{summary Nazaré}
\end{table}

\begin{table}[htbp]
\centering
\input{tables/summary_jaws500.tex}
