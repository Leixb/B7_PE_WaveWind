...
Nuestra hipótesis es que la correlación entre el viento y la altura de las olas será positiva 
...
\input{tables/summary_nazare.tex}
\input{tables/summary_jaws.tex}
